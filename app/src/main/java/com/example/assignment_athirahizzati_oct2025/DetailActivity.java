...
public class DetailActivity extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        if (c.moveToFirst()) {
            ...
            tvTotal.setText(String.format("RM %.3f", c.getDouble(c.getColumnIndexOrThrow("totalCharges"))));
            tvRebate.setText(String.format("%.2f%%", c.getDouble(c.getColumnIndexOrThrow("rebate")) * 100));
            tvFinal.setText(String.format("RM %.2f", c.getDouble(c.getColumnIndexOrThrow("finalCost"))));
        }
        c.close();
    }
